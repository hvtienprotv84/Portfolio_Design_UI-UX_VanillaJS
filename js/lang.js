const translations = {
    vn: {
        title: 'Xin Chào!',
        edu: 'Education',
        eduP: 'Đại Học Công Nghệ',
        mota_edu1: 'Đại Học Công Nghệ',
        mota_edu2: 'Đại Học Công Nghệ',
        mota_edu3: 'Đại Học Công Nghệ',
        soft: 'Software',
        lang: 'Languages',
        lang1: 'Tiếng Việt',
        lang2: 'English B1',
        name: 'Tôi là Huỳnh Vĩnh Tiến',
        ...
        figma__link: 'Figma',
        github__link: 'Github',
        facebook__link: 'Facebook',
        zalo__link: 'Zalo',
        gmail__link: 'Gmail', 
        behance__link: 'Behance',
        available: "Xin Cám Ơn Mọi Người Đã Ghé Qua Website của Mình nhé!",
        more: 'See more',
        works: 'Websites',
        work: 'Projects',
        this: 'And this :)',
...
languageSelect.addEventListener('click', function(event) {
    if (event.target.classList.contains('vn') || event.target.classList.contains('ru') || event.target.classList.contains('en')) {
